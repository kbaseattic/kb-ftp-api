 ...
 *     type - supports "file" or "folder". If set, will only return files or folders, respectively.
 *     deep - if true, will fetch files from all sub directories (default is false)
 */
